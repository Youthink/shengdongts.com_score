								...
								<div class="table-responsive">
									<table id="sample-table-2" class="table table-striped table-bordered table-hover">
										...
										<tbody> <?php foreach ($rank as $rank_items): ?>
											<tr>
											<td><?php echo $i++;?></td>
											<td><img src="<?php echo $rank_items['facelink']; ?>" width="40px"></td>
											<td><?php echo $rank_items['username']; ?></td>
											<td><?php echo $rank_items['rank']; ?></td>
											<td><?php echo $rank_items['testtime']; ?></td>
											<td><?php echo $rank_items['onejump']; ?></td>
											<td><?php echo $rank_items['twojump']; ?></td>
											<td><?php echo $rank_items['threejump']; ?></td>
											<td><a href="<?php echo site_url().'/home/deleteRank/'.$rank_items['rankid']; ?>" onclick="return confirm('确定删除吗？')" class="tooltip-error" title="Delete">删除</a>|<a href="<?php echo site_url().'/home/updateRank/'.$rank_items['rankid']; ?>" >修改</a>
											</td>
											</tr><?php endforeach; ?>
										</tbody>
									</table>
