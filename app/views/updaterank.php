							...
							<div class="col-xs-12">
                               ...
                               <h3 class="header smaller lighter blue">添加分数信息</h3>
								<div class="form-horizontal">
									...
									<?php echo form_open('home/dealRank'); ?>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">姓名</label>
										<div class="col-sm-9">
											<span class="input-icon">
											    <input type="text" id="form-field-1" name="username" value="<?php echo $rank['username'];?>"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
											    <input type="number" id="form-field-1" name="rank" value="<?php echo $rank['rank'];?>"/>
												<i class="icon-leaf green"></i>
											</span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
											    <input type="date" id="form-field-3" name="testtime" value="<?php echo $rank['testtime'];?>"/>
												<i class="icon-leaf green"></i>
											</span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
											    <input type="text" id="form-field-4" name="facelink" placeholder="粘贴头像链接" value="<?php echo $rank['facelink'];?>"/>
												<i class="icon-leaf green"></i>
											</span>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
											    <input type="number" id="form-field-5" name="onejump" value="<?php echo $rank['onejump'];?>"/>
												<i class="icon-leaf green"></i>
											</span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
											    <input type="number" id="form-field-6" name="twojump" value="<?php echo $rank['twojump'];?>"/>
												<i class="icon-leaf green"></i>
											</span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
											    <input type="number" id="form-field-7" name="threejump" value="<?php echo $rank['threejump'];?>"/>
												<i class="icon-leaf green"></i>
											</span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
											    <input type="text" id="form-field-8" name="link" value="<?php echo $rank['link'];?>"/>
												<i class="icon-leaf green"></i>
											</span>
										</div>
									</div>
